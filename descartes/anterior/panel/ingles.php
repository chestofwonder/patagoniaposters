...
echo "
		...
		<p>PANEL DE ADMINISTRACIÓN (ESPAÑOL)</p>
			...
			<table id='tabla'>		<form name='ejecuta' method='post' action='ejecutaeng.php'>
...
echo "
		...
		<form name='ejecuta' method='post' action='ejecuta2eng.php'>
			<table id='tabla'>
				<tr id='tabla1'><td>Id</td><td>Promo</td><td>Descripción</td><td>  Precio Nacional</td><td>Precio Internacional</td><td>Texto promociones</td><td>Modificar</td></tr>";
$i = 0 ; 
